        ...
        <>
            {!collapse && (
                <View style={{height: 350, flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    <Text size="xxl" fontWeight="medium">Sign In or Sign Up</Text>
                </View>
            )}
            ...
            <Tabs.Content value={tabs[0].value}>
                <View style={styles.container}>
                    <TextInput style={styles.input} placeholder='Username' onPress={handleCollapse} onChangeText={(e) => field('username').onChange(e)} />
                    <TextInput style={styles.input} placeholder='Password' onPress={handleCollapse} secureTextEntry onChangeText={(e) => field('password').onChange(e)} />
